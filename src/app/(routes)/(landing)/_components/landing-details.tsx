...
export default function LandingDetails() {
  return (
    <div className="w-full max-w-screen-2xl mx-auto px-5 md:px-14 py-10 md:min-h-[90vh] h-[80vh] 2xl:aspect-[5/2] 2xl:min-h-fit flex flex-col justify-center items-center">
